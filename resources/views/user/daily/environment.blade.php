...
@section('content')
    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-1">Laporan Harian Environment</h3>
        ...
        <div class="row">
            <div class="col-12">
                @forelse($environments as $index => $item)
                    @if ($index === 0)
                        <form id="bulk-environment-report" action="{{ route('user.daily.store-multiple') }}" method="POST"
                    ...
                    @php
                        $key = App\Models\Environment::class . '_' . $item->id;
                    ...
                    <div class="card safety-card {{ $statusClass }} mb-4 shadow-sm" data-item-id="{{ $item->id }}">
                        <div class="card-body">
                            <div class="row align-items-center mb-3">
                                ...
                                <div class="col">
                                    <h5 class="fw-bold mb-0">Environment Item</h5>
                                </div>
                                <div class="col-auto">
                                    <span
                ...
                @empty
                    <div class="card shadow-sm text-center py-5">
                        <div class="card-body">
                            ...
                            <p class="text-muted h5">Tidak ada item environment untuk tanggal ini.</p>
                        </div>
                    </div>
                @endforelse
            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const form = document.getElementById('bulk-environment-report');
            if (form) {
