...
@section('content')
    ...
    <div class="page-inner">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
                <h3 class="fw-bold mb-1">Laporan Harian Armada</h3>
        ...
        <div class="row">
            <div class="col-12">
                @forelse($armadaItems as $index => $item)
                    @if ($index === 0)
                        <form id="bulk-armada-report" action="{{ route('user.daily.store-multiple') }}" method="POST"
                    ...
                    @php
                        $key = App\Models\ArmadaItem::class . '_' . $item->id;
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2 mb-md-0">
                                        <span class="item-label-badge text-danger"><i
                                                class="fas fa-exclamation-triangle"></i> Safety Items</span>
                ...
                @empty
                    <div class="card shadow-sm text-center py-5">
                        <div class="card-body">
                            ...
                            <p class="text-muted h5">Tidak ada item armada untuk tanggal ini.</p>
                        </div>
                    </div>
                @endforelse
            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const form = document.getElementById('bulk-armada-report');
            if (form) {
