...
<div class="page-inner">
    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
            <h3 class="fw-bold mb-3">Laporan Harian Driver Item</h3>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">Driver Item</h4>
                </div>
                <div class="card-body">
                    @if(session('success'))
                    ...
                    @forelse($driverItems as $index => $item)
                        @if($index === 0)
                        ...
                        @php $key = App\Models\DriverItem::class . '_' . $item->id; $report = $reports[$key] ?? null; @endphp
                        
                        <div class="border rounded p-3 mb-3 driver-item-section" data-item-id="{{ $item->id }}">
                            <div class="mb-3">
                                <h5 class="mb-2"><span class="badge bg-primary me-2">{{ $loop->iteration }}</span>Driver Item</h5>
                                @if($item->car)
                                        ...
                                        <div class="card-body p-2">
                                            ...
                                            <div class="d-flex gap-2 mt-2">
                                                <button type="button" class="btn btn-success flex-fill capture-photo-btn" data-index="{{ $index }}">
                                                    <i class="fas fa-check-circle me-1"></i> Ambil Foto
                                                </button>
                        ...
                        @endif
                    @empty
                        <p class="text-muted">Tidak ada driver item.</p>
                    @endforelse
                </div>
            </div>
        </div>
